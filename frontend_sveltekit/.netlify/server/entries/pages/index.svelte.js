...
function writable(value, start = import_index_46d5d7a2.n) {
  let stop;
  const subscribers = /* @__PURE__ */ new Set();
  function set2(new_value) {
    if ((0, import_index_46d5d7a2.a)(value, new_value)) {
      value = new_value;
      if (stop) {
  ...
  function subscribe2(run, invalidate = import_index_46d5d7a2.n) {
    const subscriber = [run, invalidate];
    subscribers.add(subscriber);
    if (subscribers.size === 1) {
      stop = start(set2) || import_index_46d5d7a2.n;
    }
    run(value);
    return () => {
...
function derived(stores, fn, initial_value) {
  ...
  return readable(initial_value, (set2) => {
    ...
    const values = [];
    let pending = 0;
    let cleanup = import_index_46d5d7a2.n;
    const sync = () => {
      if (pending) {
        return;
      }
      ...
      if (auto) {
        ...
        cleanup = (0, import_index_46d5d7a2.i)(result) ? result : import_index_46d5d7a2.n;
      }
    };
    const unsubscribers = stores_array.map((store, i) => (0, import_index_46d5d7a2.b)(store, (value) => {
      values[i] = value;
      pending &= ~(1 << i);
      if (inited) {
        sync();
    ...
    return function stop() {
      (0, import_index_46d5d7a2.r)(unsubscribers);
      cleanup();
    };
  });
}
  ...
  for (const key in schema) {
    switch (true) {
      case (schema[key].type === "object" && !isEmpty(schema[key].fields)): {
        errors[key] = getErrorsFromSchema(initialValues[key], schema[key].fields, __spreadValues({}, errors[key]));
        break;
      }
      case schema[key].type === "array": {
        const values = initialValues && initialValues[key] ? initialValues[key] : [];
        errors[key] = values.map((value) => {
          const innerError = getErrorsFromSchema(value, schema[key].innerType.fields, __spreadValues({}, errors[key]));
...
const createForm = (config) => {
  ...
  function validateFieldValue(field, value) {
    ...
    if (validationSchema) {
      ...
      return validationSchema.validateAt(field, (0, import_index_46d5d7a2.g)(form)).then(() => util.update(errors, field, "")).catch((error) => util.update(errors, field, error.message)).finally(() => {
...
async function mutate(values) {
  ...
  const graphQLClient = new import_graphql_request.GraphQLClient(endpoint);
  ...
  return data.insert_formSubmission.returning[0];
}
var Form_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: ".container.svelte-16au2ex.svelte-16au2ex.svelte-16au2ex{width:480px;margin:0 auto}.container.svelte-16au2ex h1.svelte-16au2ex.svelte-16au2ex{margin:40px}.thisForm.svelte-16au2ex>div.svelte-16au2ex.svelte-16au2ex{text-align:left;margin:22px 0px;display:flex;justify-content:space-between}.thisForm.svelte-16au2ex>div.svelte-16au2ex>.leftbox.svelte-16au2ex{text-align:left;max-width:200px}.thisForm.svelte-16au2ex>div.svelte-16au2ex>.rightbox.svelte-16au2ex{text-align:left;max-width:200px;width:50%}.submitbutton.svelte-16au2ex.svelte-16au2ex.svelte-16au2ex{margin:0 auto;margin-top:10px;width:150px;height:34px;background-color:rosybrown;color:white}@media only screen and (max-width: 600px){.container.svelte-16au2ex.svelte-16au2ex.svelte-16au2ex{width:320px}.thisForm.svelte-16au2ex>div.svelte-16au2ex.svelte-16au2ex{text-align:left;margin:22px 0px;display:flex;justify-content:space-between}.thisForm.svelte-16au2ex>div.svelte-16au2ex>.rightbox.svelte-16au2ex{max-width:50%}.submitbutton.svelte-16au2ex.svelte-16au2ex.svelte-16au2ex{margin:0 auto;margin-top:10px;width:150px;height:50px}}",
  map: null
};
const Form = (0, import_index_46d5d7a2.c)(($$result, $$props, $$bindings, slots) => {
  let $formStatus, $$unsubscribe_formStatus;
  ...
  let formStatus = writable();
  $$unsubscribe_formStatus = (0, import_index_46d5d7a2.b)(formStatus, (value) => $formStatus = value);
  const onSubmit = async (values) => {
    console.log("form submit");
    console.log("values", values);
    (0, import_index_46d5d7a2.f)(formStatus, $formStatus = await mutate(values), $formStatus);
  };
  ...
  $$unsubscribe_form = (0, import_index_46d5d7a2.b)(form, (value) => $form = value);
  $$unsubscribe_errors = (0, import_index_46d5d7a2.b)(errors, (value) => $errors = value);
  $$unsubscribe_isValid = (0, import_index_46d5d7a2.b)(isValid, (value) => $isValid = value);
  $$unsubscribe_isSubmitting = (0, import_index_46d5d7a2.b)(isSubmitting, (value) => $isSubmitting = value);
  $$result.css.add(css$2);
  $$unsubscribe_formStatus();
  $$unsubscribe_form();
  $$unsubscribe_errors();
  $$unsubscribe_isValid();
  $$unsubscribe_isSubmitting();
  return `<div class="${"container svelte-16au2ex"}"><h1 class="${"svelte-16au2ex"}">Get a website <a href="${"/moreinfo"}">for free</a></h1>
	<form><div class="${"thisForm svelte-16au2ex"}"><div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"name"}">*Name</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"text"}" name="${"name"}" placeholder="${"Name"}"${(0, import_index_46d5d7a2.d)("value", $form.name, 0)}>
					${$errors.name ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.name)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"country"}">Country</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"text"}" name="${"country"}" placeholder="${"Country"}"${(0, import_index_46d5d7a2.d)("value", $form.country, 0)}>
					${$errors.county ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.country)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"city"}">City</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"text"}" name="${"city"}" placeholder="${"City"}"${(0, import_index_46d5d7a2.d)("value", $form.city, 0)}>
					${$errors.city ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.city)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"email"}">*Email</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"email"}" name="${"email"}" placeholder="${"Email"}"${(0, import_index_46d5d7a2.d)("value", $form.email, 0)}>
					${$errors.email ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.email)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"newsletter"}">Sign up for Newsletter</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"checkbox"}" name="${"newsletter"}"${(0, import_index_46d5d7a2.d)("value", $form.newsletter, 0)}>
					${$errors.newsletter ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.newsletter)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"telephone"}">Telephone number</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"text"}" name="${"telephone"}" placeholder="${"Telephone"}"${(0, import_index_46d5d7a2.d)("value", $form.telephone, 0)}>
					${$errors.telephone ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.telephone)}</small></div>` : ``}</div></div>

			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"project_type"}" value="${""}">*Choose project type</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><div class="${"select"}"><select name="${"project_type"}" placeholder="${"Choose"}"><option value="${""}" disabled selected>Select your option</option><option value="${"Presentation page with form"}">Presentation page with form</option><option value="${"Blog"}">Blog</option><option value="${"Webshop"}">Webshop</option><option value="${"Presentation website"}">Presentation website</option><option value="${"Other type"}">Other type</option></select>
						${$errors.project_type ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.project_type)}</small></div>` : ``}</div></div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"work_field"}">Area of activity</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"text"}" name="${"work_field"}" placeholder="${"Area of activity"}"${(0, import_index_46d5d7a2.d)("value", $form.work_field, 0)}>
					${$errors.work_field ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.work_field)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"start_time"}">Activity start date</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"date"}" name="${"start_time"}" placeholder="${"start_time"}"${(0, import_index_46d5d7a2.d)("value", $form.start_time, 0)}>
					${$errors.start_time ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.start_time)}</small></div>` : ``}</div></div>
			<div class="${"svelte-16au2ex"}"><div class="${"leftbox svelte-16au2ex"}"><label for="${"comment"}">Your comment</label></div>
				<div class="${"rightbox svelte-16au2ex"}"><input type="${"text"}" name="${"comment"}" placeholder="${"..."}"${(0, import_index_46d5d7a2.d)("value", $form.comment, 0)}>
					${$errors.comment ? `<div style="${"color:red;"}"><small>${(0, import_index_46d5d7a2.e)($errors.comment)}</small></div>` : ``}</div></div>
			<p style="${"font-size: 14px; text-align: left;"}">* Required</p>

			<div class="${"svelte-16au2ex"}"><button class="${"submitbutton svelte-16au2ex"}" type="${"submit"}" ${!$isValid ? "disabled" : ""}>${$isSubmitting ? `loading...` : `Submit`}</button></div>
			${$formStatus ? `<p>Hi ${(0, import_index_46d5d7a2.e)($formStatus.name)}, we have recieved your reply! \u{1F600}
				</p>` : ``}</div></form>
</div>`;
});
...
const Swiper = (0, import_index_46d5d7a2.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_46d5d7a2.h)($$props, ["class", "swiper"]);
  const dispatch = (0, import_index_46d5d7a2.j)();
  ...
  const setVirtualData = (data) => {
    virtualData = data;
    (0, import_index_46d5d7a2.t)().then(() => {
  ...
  (0, import_index_46d5d7a2.s)("swiper", swiperInstance);
  ...
  return `<div${(0, import_index_46d5d7a2.k)([
    {
      class: (0, import_index_46d5d7a2.l)(uniqueClasses(`${containerClasses}${className ? ` ${className}` : ""}`))
    },
    (0, import_index_46d5d7a2.p)(restProps)
  ], {})}${(0, import_index_46d5d7a2.d)("this", swiperEl, 0)}>${slots["container-start"] ? slots["container-start"]({ virtualData }) : ``}
  ${needsNavigation(swiperParams) ? `<div class="${"swiper-button-prev"}"${(0, import_index_46d5d7a2.d)("this", prevEl, 0)}></div>
    <div class="${"swiper-button-next"}"${(0, import_index_46d5d7a2.d)("this", nextEl, 0)}></div>` : ``}
  ${needsScrollbar(swiperParams) ? `<div class="${"swiper-scrollbar"}"${(0, import_index_46d5d7a2.d)("this", scrollbarEl, 0)}></div>` : ``}
  ${needsPagination(swiperParams) ? `<div class="${"swiper-pagination"}"${(0, import_index_46d5d7a2.d)("this", paginationEl, 0)}></div>` : ``}
...
const Swiper_slide = (0, import_index_46d5d7a2.c)(($$result, $$props, $$bindings, slots) => {
  let slideData;
  let $$restProps = (0, import_index_46d5d7a2.h)($$props, ["zoom", "virtualIndex", "class"]);
  let { zoom = void 0 } = $$props;
  let { virtualIndex = void 0 } = $$props;
  let { class: className = void 0 } = $$props;
  let slideEl = null;
  let slideClasses = "swiper-slide";
  let swiper = (0, import_index_46d5d7a2.q)("swiper");
  ...
  return `<div${(0, import_index_46d5d7a2.k)([
    {
      class: (0, import_index_46d5d7a2.l)(uniqueClasses(`${slideClasses}${className ? ` ${className}` : ""}`))
    },
    {
      "data-swiper-slide-index": (0, import_index_46d5d7a2.l)(virtualIndex)
    },
    (0, import_index_46d5d7a2.p)($$restProps)
  ], {})}${(0, import_index_46d5d7a2.d)("this", slideEl, 0)}>${zoom ? `<div class="${"swiper-zoom-container"}"${(0, import_index_46d5d7a2.d)("data-swiper-zoom", typeof zoom === "number" ? zoom : void 0, 0)}>${slots.default ? slots.default({ data: slideData }) : ``}</div>` : `${slots.default ? slots.default({ data: slideData }) : ``}`}</div>`;
});
var swiper_min = "";
var navigation_min = "";
var pagination_min = "";
var scrollbar_min = "";
const Swiper_1 = (0, import_index_46d5d7a2.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_46d5d7a2.v)(Swiper, "Swiper").$$render($$result, {
...
${(0, import_index_46d5d7a2.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img src="${"/animals/lynx.jpg"}" width="${"200"}" height="${"200"}" alt="${"some animal"}">`;
        }
      })}
${(0, import_index_46d5d7a2.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img src="${"/animals/owl.jpg"}" width="${"200"}" height="${"200"}" alt="${"some animal"}">`;
        }
      })}
${(0, import_index_46d5d7a2.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img src="${"/animals/elep.jpg"}" width="${"200"}" height="${"200"}" alt="${"some animal"}">`;
        }
      })}
${(0, import_index_46d5d7a2.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img src="${"/animals/deer.jpg"}" width="${"200"}" height="${"200"}" alt="${"some animal"}">`;
        }
      })}
${(0, import_index_46d5d7a2.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img src="${"/animals/somCat.jpg"}" width="${"200"}" height="${"200"}" alt="${"some animal"}">`;
        }
      })}
${(0, import_index_46d5d7a2.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
