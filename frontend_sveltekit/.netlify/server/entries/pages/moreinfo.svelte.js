...
const Moreinfo = (0, import_index_46d5d7a2.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-1vgpx7r"}"><div class="${"container svelte-1vgpx7r"}"><h1 class="${"svelte-1vgpx7r"}">Reach people online</h1>
		<div class="${"toppart part svelte-1vgpx7r"}"><h2 class="${"svelte-1vgpx7r"}">With our 1 year free* offer, you can choose between following website types:</h2>
			<div class="${"list svelte-1vgpx7r"}"><ul class="${"svelte-1vgpx7r"}"><li class="${"svelte-1vgpx7r"}">Presentation page with form</li>
					<li class="${"svelte-1vgpx7r"}">Blog</li>
					<li class="${"svelte-1vgpx7r"}">Webshop</li>
			...
			<div class="${"lastlist svelte-1vgpx7r"}"><ul class="${"svelte-1vgpx7r"}"><li class="${"svelte-1vgpx7r"}">Easy for you:, just send us your content in an email, give us your story, and we
						will take care of the rest!
					</li>
					<li class="${"svelte-1vgpx7r"}">Get a foundation for the future growth of your activity!</li></ul></div>
		</div><div class="${"bottompart part svelte-1vgpx7r"}"><p class="${"svelte-1vgpx7r"}"><i class="${"svelte-1vgpx7r"}">We look for partners for multiyear business relationships</i></p>

			<p class="${"svelte-1vgpx7r"}"><b class="${"svelte-1vgpx7r"}">Build your online presence step-by-step with our modular project approach</b></p>
